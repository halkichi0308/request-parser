...
import burp.com.burp.assets.DefaultTemplate;
...
public class ExtentionTab extends JPanel {
    ...
    private void initComponents() {
        ...
        clearButton.addActionListener(e -> {
            ...
            requestTextArea.setText(DefaultTemplate.getFormatTemplate());
        ...
        jLayeredRightLayout.setHorizontalGroup(jLayeredRightLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                .addGroup(jLayeredRightLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addComponent(radioBtn_SJIS).addComponent(radioBtn_EUC).addComponent(radioBtn_UTF8)
         ...
         */
        jLayeredRightLayout.setVerticalGroup(jLayeredRightLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                .addGroup(jLayeredRightLayout.createSequentialGroup().addGap(14, 14, 14).addComponent(radioBtn_UTF8)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(radioBtn_SJIS)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(radioBtn_EUC)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(radioBtn_RAW)
                        // .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jSeparator1).addGap(18, 18, 18))
                .addGroup(jLayeredRightLayout.createParallelGroup().addComponent(infoLabel, GroupLayout.PREFERRED_SIZE,
                        700, GroupLayout.PREFERRED_SIZE)// 700 = witdh
                ));
                ...
                layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup()
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        .addComponent(headerPanel, GroupLayout.PREFERRED_SIZE, 300,
                                                GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jScrollPane1, GroupLayout.PREFERRED_SIZE, 700,
                                                GroupLayout.PREFERRED_SIZE)))
                        .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(clearButton)
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
    ...
    public byte decodeChecked() {
        return (byte) (radioBtn_UTF8.isSelected() ? 1
                : radioBtn_SJIS.isSelected() ? 2 : radioBtn_EUC.isSelected() ? 3 : 0);
    }
}
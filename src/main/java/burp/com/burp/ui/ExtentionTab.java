...
public class ExtentionTab extends JPanel {
        ...
        private void initComponents() {
                ...
                jLayeredRightLayout.setHorizontalGroup(jLayeredRightLayout
                                .createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addGroup(jLayeredRightLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addComponent(radioBtn_SJIS).addComponent(radioBtn_EUC)
                                                .addComponent(radioBtn_UTF8).addComponent(radioBtn_RAW))
                                .addComponent(jSeparator1)
                                // .addComponent(jSeparator1, GroupLayout.PREFERRED_SIZE,
                                // GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                .addComponent(infoLabel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                                Short.MAX_VALUE));
                ...
                jLayeredRightLayout.setVerticalGroup(
                                jLayeredRightLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                                .addGroup(jLayeredRightLayout.createSequentialGroup().addGap(14, 14, 14)
                                                ...
                                                .addGroup(jLayeredRightLayout.createParallelGroup().addComponent(
                                                                infoLabel, GroupLayout.PREFERRED_SIZE, 700,
                                                                GroupLayout.PREFERRED_SIZE)// 700 = witdh
                                                ));
                ...
                layout.setVerticalGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout
                                                ...
                                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                                                .addComponent(jScrollPane1, GroupLayout.PREFERRED_SIZE,
                                                                                661, GroupLayout.PREFERRED_SIZE)
                                                                .addGroup(layout.createParallelGroup(
                                                                                GroupLayout.Alignment.TRAILING)
                                                                                // .addGap(18, 18, 18)
                                                                                .addComponent(jLayeredPane1,
